...
const gray8 = '#f2f2f2';
const yellow = '#ffc415';
const yellow1 = '#FFA830';
const yellow2 = '#FFC120';
const green1 = '#32ccb0';
const green2 = '#5cba47';
const orange1 = '#fdb918';
const orange2 = '#ff3d2e';
const orange3 = '#FF294F';
...
const background = {
  ...
  red: '#FF294F',
  black: black,
  themeLight: 'rgba(13, 130, 255, .2)',
  darkBlue: '#0055AF',
  themeLight2: 'rgba(13, 130, 255, 0.8)',
  chatColor: '#F2F7FB',
  screenBg: 'rgba(255,255,255,0.5)',
};
...
const borders = {
  input: 'rgba(55, 55, 55, 0.1)',
  inputFocused: 'rgba(13, 130, 255, 1)',
};

const placeHolderColor = 'rgba(55, 55, 55, 0.2)';
export default {
  white,
  black,
  black1,
